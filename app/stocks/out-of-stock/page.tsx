...
import { getOutOfStocks } from '@/server/product';
...
const OutOfStock = () => {
  ...
  return (
    <div className="p-4">
      <h4 className='text-2xl font-bold text-center mb-5 uppercase'>Out of Stocks</h4>
      ...
      {currentItems.length === 0 ? (
        <div className="text-center py-10">
          <p className="text-lg">No out of stocks found</p>
          {searchTerm && (
            <button
