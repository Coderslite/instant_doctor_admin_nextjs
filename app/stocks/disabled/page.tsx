...
const DisabledStock = () => {
  return (
    <div>
      <h4 className='text-2xl font-bold text-center mb-5 uppercase'>Disabled Stocks</h4>
      ...
      <div className='grid md:grid-cols-5 grid-cols-1 gap-4 mt-5'>
        {drugs.map((drug) => (
          <div key={drug.id} className='bg-gray rounded-2xl flex flex-col justify-between items-center p-2'>
            <div className='bg-red-700 text-white p-2 rounded-2xl'>
