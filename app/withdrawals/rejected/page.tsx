                ...
                <table className="min-w-full text-sm text-left text-gray-500">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="px-4 py-3">Rejected By</th>
                        ...
                        {filteredWithdrawals.length === 0 ? (
                            ...
                            filteredWithdrawals.map((withdrawal) => (
                                <tr key={withdrawal.id} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-4">{withdrawal.rejectedBy || 'System'}</td>
                                    <td className="px-4 py-4 max-w-xs truncate" title={withdrawal.rejectionReason}>
