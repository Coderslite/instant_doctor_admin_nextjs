...
import { getCancelledAppointments } from '@/server/appointment'
...
const CancelledAppointments = () => {
    ...
    useEffect(() => {
        const fetchAppointments = async () => {
            try {
                setLoading(true)
                const CancelledAppointments = await getCancelledAppointments()
    ...
    return (
        <div className="p-4">
            <h4 className='text-3xl font-bold text-center mb-5 uppercase'>Cancelled Appointments</h4>
