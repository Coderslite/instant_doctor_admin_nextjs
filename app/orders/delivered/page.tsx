                ...
                <table className="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td className="px-4 py-4"><span className='bg-green text-white rounded-2xl px-8 pb1 py-1 text-xs'>Completed</span></td>
                            <td className="px-4 py-4">$2999</td>
                            <td className="px-4 py-4">Today</td>
                            <td className="px-4 py-4">121212121</td>
                            <td className="px-4 py-4"><a href="details/12" className='btn bg-blue text-white px-5 py-2 pb-2 rounded-2xl'>View</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
