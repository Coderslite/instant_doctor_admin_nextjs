...
//             await updateOrderStatusInFirestore(params.id, newStatus);
...
//                     body = `Your order #${params.id.slice(0, 8)} has been confirmed`;
//                     type = 'order_confirmed';
//                     break;
//                 case 'delivering':
//                     title = 'On The Way';
//                     body = `Your order #${params.id.slice(0, 8)} is out for delivery`;
//                     type = 'order_delivering';
//                     break;
//                 case 'completed':
//                     title = 'Order Delivered';
//                     body = `Your order #${params.id.slice(0, 8)} has been delivered`;
